...
const TimeoutSlider: React.FC<TimeoutSliderProps> = ({
  tasks,
  setTasks,
  onTaskAdded,
}) => {
    ...
    <div className="relative w-[354px] h-[668px] pt-[20px] pb-[20px] gap-[16px] rounded-[10px]  bg-[#ECEDEE] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] flex flex-col items-center overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex gap-[12px] w-[143] h-[20px]">
        <div className="w-[111] h-[19px] gap-[9px]  flex items-center justify-between ">
          <span className="w-[8px] h-[8px] top-[25px] left-[132px] bg-red-600 rounded-full">
            {" "}
          </span>
      ...
      {/* border line */}
      <div className="w-[314px] h-[3px] border-[3px] border-red-600"></div>
      {/* 1 card */}
      {tasks.length === 0 ? (
        <p className="mt-4 text-center text-gray-500">No tasks available.</p>
      ) : (
        tasks.map((task) => {
          ...
          return (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                {openMenuId === task._id && (
                  <div className="absolute bg-white shadow-lg rounded-md py-2 z-10 w-32 ml-[250px] mt-24">
                    <button
                      onClick={() => {
              ...
              <div className="w-[261px] h-[16px] mt-8 flex gap-[10px]">
                <div className="w-[107px] h-[16px] flex  gap-[3px]">
                  <p className=" w-[107px] h-[16px] font-[Poppins] font-bold text-[12px] text-[rgba(90,90,90,1)]">
                    Deadline:
                  </p>
